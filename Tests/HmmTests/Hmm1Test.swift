...
final class Hmm1Test: XCTestCase {
    func testViterbi() {
        ...
        states.insert("HOT")
        states.insert("COLD")
        let hmm1 : Hmm1<String, Int> = Hmm1<String, Int>(states: states, observations: observations, emittedSymbols: emittedSymbols)
        var observed : [Int] = [1, 1, 1, 1, 1, 1]
        var observedStates : [String] = hmm1.viterbi(s: observed)
        ...
        observedStates = hmm1.viterbi(s: observed)
        XCTAssertEqual("COLD", observedStates[0])
